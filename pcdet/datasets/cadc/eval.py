# Kitti / COCO style evaluation. Adapted from https://github.com/traveller59/second.pytorch/blob/master/second/utils/eval.py 
# In contrast to pcdet.datasets.kitti.kitti_object_eval_python, this module works in LIDAR frame.
