...
import os
from pcdet.datasets.cadc.cadc_dataset import BaseCadcDataset


REPO_DIR='/home/cyz/cadc_tracker/PCDet'
ROOT_PATH=os.path.join(REPO_DIR, 'data/cadcd')
RESULT_PATH= os.path.join(REPO_DIR,'output/pointpillar_cadc/default/eval/epoch_80/val/default/result.pkl')
